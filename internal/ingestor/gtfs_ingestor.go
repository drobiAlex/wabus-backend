...
func (i *GTFSIngestor) update(ctx context.Context) {
	...
	i.store.UpdateAll(result.Routes, result.Shapes, result.Stops, result.RouteShapes, result.StopSchedules, result.StopLines, result.Calendars, result.CalendarDates)
